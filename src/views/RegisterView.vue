      ...
      >
        ...
        >
          ...
          >
            <path
              fill="currentColor"
              d="M100 50.241c0-27.393-22.383-49.776-49.776-49.776S.448 22.848.448 50.241c0 27.392 22.383 49.775 49.776 49.775S100 77.633 100 50.241z"
              opacity=".25"
            />
            <path
              fill="currentFill"
              d="M93.974 50.241c0-23.664-19.21-42.874-42.874-42.874s-42.874 19.21-42.874 42.874c0 23.663 19.21 42.873 42.874 42.873s42.874-19.21 42.874-42.873z"
            />
          </svg>
          Carregando...
        </button>
...
const registerUser = async () => {
  ...
  try {
    ...
    message.setMessage(response.data.message , true)
